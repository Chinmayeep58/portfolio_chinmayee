...
Command: npx gltfjsx@6.5.3 public/models/Standing Desk.glb -o src/components/Desk.jsx -k -K -r public 
*/
...
export function Desk(props) {
  const { nodes, materials } = useGLTF('/models/Standing Desk.glb')
  return (
      ...
      <group name="Root_Scene">
        <group name="RootNode">
          <group name="Dual_Monitors_on_sit-stand_arm" position={[-0.294, 1.36, -6.337]} rotation={[-Math.PI / 2, 0, 0]} scale={30.19}>
            ...
            <mesh name="Dual_Monitors_on_sit-stand_arm|group974294459|Dupli|17" geometry={nodes['Dual_Monitors_on_sit-stand_arm|group974294459|Dupli|17'].geometry} material={materials['mat23.015']} />
          ...
          <group name="Keyboard" position={[-0.284, 1.216, -6.705]} rotation={[-1.576, -0.001, 3.102]} scale={20.517}>
          ...
          <mesh name="Mousepad001" geometry={nodes.Mousepad001.geometry} material={materials.Mousepad} position={[-1.132, 0.944, -6.86]} rotation={[-Math.PI / 2, 0, Math.PI / 2]} scale={[17.231, 20.977, 0.228]} />
          ...
          <mesh name="Mouse001" geometry={nodes.Mouse001.geometry} material={materials['Material.001']} position={[-1.139, 0.942, -6.856]} rotation={[-Math.PI / 2, 0, -2.69]} scale={10000} />
        </group>
      </group>
    </group>
  )
...
useGLTF.preload('/models/Standing Desk.glb')
